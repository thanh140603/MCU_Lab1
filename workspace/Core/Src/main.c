...
void display7SEG2(int num){
	switch(num){
		case 0:
			...
			HAL_GPIO_WritePin ( LED_E2_GPIO_Port , LED_E2_Pin , GPIO_PIN_RESET ) ;
			HAL_GPIO_WritePin ( LED_F2_GPIO_Port , LED_F2_Pin , GPIO_PIN_RESET ) ;
		...
		case 1:
			...
			HAL_GPIO_WritePin ( LED_E2_GPIO_Port , LED_E2_Pin , GPIO_PIN_SET ) ;
			HAL_GPIO_WritePin ( LED_F2_GPIO_Port , LED_F2_Pin , GPIO_PIN_SET ) ;
			HAL_GPIO_WritePin ( LED_G2_GPIO_Port , LED_G2_Pin , GPIO_PIN_SET ) ;
			break;
		case 2:
			HAL_GPIO_WritePin ( LED_A2_GPIO_Port , LED_A2_Pin , GPIO_PIN_RESET ) ;
